<%@page contentType="image/jpeg" import="java.io.*,java.util.*,java.awt.*,java.awt.image.*,javax.imageio.*,com.sun.image.codec.jpeg.JPEGCodec,com.sun.image.codec.jpeg.JPEGImageEncoder;"%>
<%
/*
使用方法：在需要显示验证码的html代码中使用<img>
在需判断session的时候判断session.getAttribute("veriCode")
*/
...
// 在内存中创建图象
int width = 15*codeLength+6, height = 40;
